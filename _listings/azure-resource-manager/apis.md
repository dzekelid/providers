...
- name: Azure Resource Manager API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/providers/master/_listings/azure-resource-manager/subscriptions-subscriptionid-providers-resourceprovidernamespace-register-post.md
x-common:
- type: x-website
